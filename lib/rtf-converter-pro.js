...
class RtfParser {
    ...
    parseHexChar() {
        ...
        try {
            ...
            if (process.env.DEBUG) {
                console.log(`Hex: ${hexCode}, Code: ${charCode}, Font: ${this.state.font}, Charset: ${currentFont === null || currentFont === void 0 ? void 0 : currentFont.charset}`);
            }
    ...
    syncStateToHtml(oldState, newState) {
